...
WebUI.verifyElementText(findTestObject('Object Repository/Page_Logged In Successfully  Practice Test _c87e4f/h1_Logged In Successfully'), 
    'Logged In Successfully')

WebUI.verifyElementText(findTestObject('Object Repository/Page_Logged In Successfully  Practice Test _c87e4f/strong_Congratulations student. You success_9f23b9'), 
    'Congratulations student. You successfully logged in!')

WebUI.verifyElementVisible(findTestObject('Object Repository/Page_Logged In Successfully  Practice Test _c87e4f/a_Log out'))
